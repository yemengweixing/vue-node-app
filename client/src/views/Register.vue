...
export default {
    ...
    components:{
     ...
     data(){
      ...
      rules: {
        name: [
          { required: true, message: "用户名不能为空", trigger: "change" },//规则1 不为空
          { min: 2, max: 30, message: "长度在 2 到 30 个字符", trigger: "blur" }//规则2 长度
        ],
        email: [
          {
            type: "email",
        ...
        password2: [
          ...
          { validator: validatePass2, trigger: "blur" }//validator检测器 validator：检测函数
        ]
      }
        }
    },
